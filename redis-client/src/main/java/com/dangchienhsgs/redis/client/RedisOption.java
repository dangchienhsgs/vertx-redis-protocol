...
public class RedisOption {
    ...
    public RedisOption(RedisOption options) {
        this(options.toJSON());
    }
     ...
     * @return self
     */
    public RedisOption setEncoding(String encoding) {
     ...
     * @return self
     */
    public RedisOption setBinary(boolean binary) {
     ...
     * @return self
     */
    public RedisOption setAddress(String address) {
     ...
     * @return self
     */
    public RedisOption setHost(String host) {
        json.put("host", host);
        return this;
    }
     ...
     * @return self
     */
    public RedisOption setPort(int port) {
        json.put("port", port);
        return this;
    }
     ...
     * @return self
     */
    public RedisOption setTcpKeepAlive(boolean tcpKeepAlive) {
     ...
     * @return self
     */
    public RedisOption setTcpNoDelay(boolean tcpNoDelay) {
     ...
     * @return self
     */
    public RedisOption setAuth(String auth) {
        json.put("auth", auth);
        return this;
    }
     ...
     * @return self
     */
    public RedisOption setSelect(Integer select) {
        if (select != null) {
